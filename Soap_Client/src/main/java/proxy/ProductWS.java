 ...
 * 
 */
@WebServiceClient(name = "ProductWS", targetNamespace = "http://webService.soapserver.example.com/", wsdlLocation = "http://localhost:8084/ProductWS?wsdl")
    ...
    extends Service
{
    ...
    private static final QName PRODUCTWS_QNAME = new QName("http://webService.soapserver.example.com/", "ProductWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8084/ProductWS?wsdl");
    ...
    public ProductWebService getProductWebServicePort() {
        return super.getPort(new QName("http://webService.soapserver.example.com/", "ProductWebServicePort"), ProductWebService.class);
    }
    ...
    public ProductWebService getProductWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webService.soapserver.example.com/", "ProductWebServicePort"), ProductWebService.class, features);
    }
